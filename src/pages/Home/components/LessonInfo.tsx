...
function LessonInfo() {
  ...
  const lessonInfo = [
    {
      title: "전공반 / 입시반",
      desc: "영재 · 예중 · 예고 · 음대 · 대학원 · 유학 대비 커리큘럼",
      icon: SchoolOutlined,
      items: [
        "1회 60~90분 | 집중 1:1 개인 레슨",
        "영재원, 예중, 예고, 음대입시, 편입, 독일 유학까지 장기 플랜 설계",
        "교수님 레슨 외 보충레슨을 원하는 학생(대학생/대학원생)",
        "피아노 실기시험을 위한 작곡/지휘입시생",
        "클래스 연주회·홀 연습 등 정기 무대 경험 제공",
        "콩쿨·실기 대비 음대 교수님, 강사님들을 초청, 자체 모의평가로 실전 감각 강화",
      ],
    },
    {
      title: "취미반",
